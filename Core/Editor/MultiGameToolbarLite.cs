...
namespace MultiGame {
	...
	public class MultiGameToolbarLite : MGEditor {
		#if UNITY_EDITOR
...
//		private static Texture2D photonChannelIcon;
		...
		[MenuItem ("Window/MultiGame/Rapid Dev Tool (Lite)")]
		public static void  ShowWindow () {
			EditorWindow.GetWindow(typeof(MultiGameToolbarLite));
		}
...
//			GUILayout.Box("UNet components are always added to the root object.","box",GUILayout.Width(112f));
			...
			EditorGUILayout.BeginVertical("box", GUILayout.Width(112f));
			GUILayout.Label ("Coming soon!","box");
