...
public class ParseInventory : Photon.MonoBehaviour {

	public static ParseInventory localInventory;
...
//		}
		...
		ParseActiveItem activeItem = inGameObject.GetComponent<ParseActiveItem>();
